...
class Zhihu2Spider(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        btn_login = driver.find_element_by_xpath(
            r'//button[@class="Button SignFlow-submitButton Button--primary Button--blue"]')
        ...
        response = FormRequest(url="https://www.zhihu.com/", cookies=cookies, callback=self.after_login,
                               meta={'cookiejar': 1})
        return [response]
    ...
    def make_requests_from_url(self, url, response):
        ...
        return Request(url, dont_filter=False, meta={"cookiejar": response.meta["cookiejar"]}, callback=self.parse)
